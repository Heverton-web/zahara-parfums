...
import { TrendingUp, TrendingDown, DollarSign, Percent, Search, Loader2, Check, ArrowRight, RefreshCw, AlertCircle } from 'lucide-react'
...
export default function PrecosEmMassa() {
  ...
  // Função utilitária para calcular o novo preço com base nos controles
  function calcularNovosPrecos(produto) {
    ...
    // Ajustar preço promocional (somente se já existia ou se afetado)
